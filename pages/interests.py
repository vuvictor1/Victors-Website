...
title_style = f'{base_style} font-size: 32px; margin-top: -60px;'
...
def interests_page(): # Interests page
    ...
    with ui.row().style(row_style): # Create a row
        ...
        with ui.row().style(row_style): # Create a row for interests
            with ui.column().style(column_style): 
                with ui.card().classes('about-me').style(card_style): # Create a card for Japanese Language Analysis
                    create_label('Japanese Language Analysis', sub_style) # sub label 
                ...
                with ui.card().classes('about-me').style(card_style): # Create a card for vocal percussion
                ...
                ui.separator() 
                with ui.card().classes('about-me').style(card_style): # Create a card for music
                    ...
                    create_image('https://i.imgur.com/gh0tDaU.png') # display image

                ui.separator()
                with ui.card().classes('about-me').style(card_style): # Create a card for aquarium
