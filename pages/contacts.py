...
def contacts_page(): # Contacts page
    ...
    with ui.row().classes('justify-center w-full my-4'): # Center the contacts title
        ...
        with ui.column().style('max-width: 90%;').classes('items-center text-center p-5 bg-gray-800 rounded-lg shadow-lg outline_label'):
            ...
            ui.html(f'''
                <form action="https://api.web3forms.com/submit" method="POST" style="width: 100%;">
                    ...
                    <textarea name="message" placeholder="Your Message" required style="font-size: 1rem; width: 100%; height: 200px; margin-bottom: 10px; background-color: #3B3B3B; color: white; border: none; padding: 10px; border-radius: 5px;"></textarea>
