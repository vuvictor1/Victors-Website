...
def projects_page(): # Projects page main function
    ...
    with ui.row().style('justify-content: center; width: 100%; margin-top: -40px;'): # Projects title
    ...
    with ui.row().style('justify-content: center; width: 100%; margin-top: 20px;'): # Projects content
        with ui.column().style('align-items: center; text-align: center;'):
            ui.html(f'<lottie-player src="{lottie_3_url}" loop autoplay speed="0.25" style="height: 400px; margin-top: -100px;"></lottie-player>') # play lottie animation
    ...
    with ui.row().style('justify-content: center; width: 100%; margin-top: 20px;'): # Research projects content
        with ui.column().style('align-items: center; text-align: center;'):
            ui.html(f'<lottie-player src="{lottie_4_url}" loop autoplay speed="0.25" style="height: 400px; margin-top: -80px;"></lottie-player>')
